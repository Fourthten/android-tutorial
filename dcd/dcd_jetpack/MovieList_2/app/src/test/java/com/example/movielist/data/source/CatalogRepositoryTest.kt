...
import com.example.movielist.LiveDataTestUtil
...
class CatalogRepositoryTest {
    ...
    private val listMovieResponse = DummyData.generateDataMovieDummyResponse()
    private val movieId = listMovieResponse[0].id
    private val listTvShowResponse = DummyData.generateDataTvShowDummyResponse()
    private val tvShowId = listTvShowResponse[0].id
    private val movieResponse = DummyData.generateDataMovieDummyResponse()[0]
    private val tvShowResponse = DummyData.generateDataTvShowDummyResponse()[0]
